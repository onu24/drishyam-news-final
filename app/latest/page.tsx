...
export const metadata = {
  title: 'Latest News - Drishyam News',
  description: 'Chronological feed of the latest breaking news and stories from India and around the world.',
};
      ...
      <main className="flex-1 w-full bg-secondary/10 pb-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 lg:py-12">
          ...
          <div className="mb-8 pb-4 border-b-2 border-primary/20">
            <h1 className="font-serif text-3xl sm:text-4xl lg:text-5xl font-bold flex items-center">
              <Clock className="mr-3 h-8 w-8 text-primary" />
              Latest Updates
            </h1>
            <p className="mt-3 text-lg text-muted-foreground font-hindi">
              Catch up on the newest stories as they happen.
            </p>
          </div>
