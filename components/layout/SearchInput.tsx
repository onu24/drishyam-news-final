    ...
    <div className="relative w-full max-w-sm ml-auto" ref={dropdownRef}>
      <form onSubmit={handleSearch} className="relative group">
        <input
          ...
          placeholder="Search..."
          className="w-full bg-secondary placeholder:text-muted-foreground text-foreground px-4 py-2 rounded-full text-sm border-transparent focus:border-primary focus:ring-1 focus:ring-primary focus:outline-none transition-all pl-10 pr-10"
        />
                ...
                {results.map((article) => (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <h4 className="text-sm font-bold leading-tight line-clamp-2 font-serif group-hover:text-primary transition-colors">
                        {article.title}
                      </h4>
